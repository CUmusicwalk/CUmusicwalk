...
var other = [
  ...
  var content = [
    ...
    '<div class="info-window"><div class="info-window-header"><img id="checkin" src="icon/3c.png"><h1>ลานไทร ครุศาสตร์</h1><h3>FACULTY OF EDUCATION</h3><div class="facility"></div></div><div class="info-window-pic"><img src="image/edu.png"></div><div class="info-window-content"><img id="show-type" src="icon/Concert.png"><p id="type"><แสดงดนตรีโดย: TBA></p><p id="content">ในปีพ.ศ. 2500 คณะครุศาสตร์แยกออกจากคณะอักษรศาสตร์และสถาปนาเป็นคณะที่ 7 ของจุฬาฯ</p><p id="l49">*ลานไทรอยู่ตรงข้ามโรงอาหาร<br>การแสดงเวลา: TBA>*</p><button><a href="info.html">เพิ่มเติม ></a></button></div></div>',
    ...
    '<div class="info-window"><div class="info-window-header"><img id="checkin" src="icon/5c.png"><h1>เรือนภะรตราชา</h1><h3>RUAN PAROT RACHA (พ.ศ.2456)</h3><div class="facility"></div></div><div class="info-window-pic"><img src="image/parata.png"></div><div class="info-window-content"><img id="show-type" src="icon/Concert.png"><p id="type"><แสดงดนตรีโดย: TBA>></p><p id="content">เรือนที่ใช้เป็นบ้านพักอาจารย์ในสมัยร.6 ภายหลังได้รับการซ่อมแซมจนได้เป็นอาคารอนุรักษ์ดีเด่น และตั้งชื่อเป็นที่ระลึกถึงพระยาภะรตราชา</p><p id="l57">การแสดงเวลา: TBA></p><button><a href="info.html">เพิ่มเติม ></a></button></div></div>',
    '<div class="info-window"><div class="info-window-header"><img id="checkin" src="icon/6c.png"><h1>ลานพิพิธศิลป์</h1><h3></h3><div class="facility"></div></div><div class="info-window-pic"><img src="image/run.png"></div><div class="info-window-content"><img id="show-type" src="icon/Concert.png"><img id="show-type2" src="icon/Exhibition.png"><p id="type"><แสดงดนตรีโดย: TBA>><br><นิทรรศการนวัตกรรมจุฬาฯ></p><p id="content" style="top:30%!important">ลานข้างอาคารพิพิธภัณฑ์จุฬาฯ มีเอกลักษณ์คือ รูปปั้นบูมบาลาก้า</p><p id="l49">*การแสดงเวลา: TBA>*<br>*นิทรรศการอยู่บริเวณข้างลาน*</p><button><a href="info.html">เพิ่มเติม ></a></button></div></div>',
    ...
    '<div class="info-window"><div class="info-window-header"><img id="checkin" src="icon/9c.png"><h1>ลานจักรพงษ์</h1><h3>CHAKKRABHONG SQUARE</h3><div class="facility"></div></div><div class="info-window-pic"><img src="image/Chakkapong.png"></div><div class="info-window-content"><img id="show-type" src="icon/Concert.png"><img id="show-type2" src="icon/Exhibition.png"><p id="type"><แสดงดนตรีโดย: TBA>><br><นิทรรศการนวัตกรรมจุฬาฯ></p><p id="content" style="top:30%!important">ในปีพ.ศ. 2557 ได้มีเปลี่ยนแปลงบริเวณนี้จากสระว่ายน้ำเป็นสนามหญ้า</p><p id="l51">*นิทรรศการจัดหน้าตึกมหาวชิรุณหิศ*<br>*การแสดงเวลา: TBA>*</p><button><a href="info.html">เพิ่มเติม ></a></button></div></div>',
    '<div class="info-window"><div class="info-window-header"><img id="checkin" src="icon/white.png"><h1 style="margin-top: 5%!important">PINK MARKET</h1><div class="facility"></div></div><div class="info-window-pic"><img src="image/pinkmarket.jpg" style="border-radius:5px!important;"></div><div class="info-window-content"><img id="show-type" src="icon/Concert.png"><p id="type"><เวทีดนตรีหลัก></p><p id="content">หลังจากที่เดินชมจุดเช็คอินครบทั้ง 9 จุดแล้ว ขอเชิญทุกท่านมาที่ Pink market ซึ่งอยู่บริเวณลานตรงหน้าพระบรมรูปสองรัชกาล ซึ่งมีร้านค้ามาออกงานกันมากกว่า 50 ร้าน และดนตรีเวทีใหญ่</p><button><a href="info.html">เพิ่มเติม ></a></button></div></div>'
  ]
