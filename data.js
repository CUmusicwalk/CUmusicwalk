...
var other = [
    ...
    {lat:13.735880571325103, lng:100.53131306636395},
    {lat:13.73650078923981, lng:100.53174289838695},
    {lat:13.74010025388088, lng:100.52887428982625}
  ...
  var content = [
    ...
    '<div class="info-window"><div class="info-window-header"><img id="checkin" src="icon/3c.png"><h1>ลานไทร ครุศาสตร์</h1><h3>FACULTY OF EDUCATION</h3><div class="facility"></div></div><div class="info-window-pic"><img src="image/edu.png"></div><div class="info-window-content"><img id="show-type" src="icon/Concert.png"><p id="type"><แสดงโดย: เภตรา (บัญชี), Lmaoband (นิติฯ), Tools bar (สถาปัตฯ)></p><p id="content" style="top:30%!important">ในปีพ.ศ. 2500 คณะครุศาสตร์แยกออกจากคณะอักษรศาสตร์และสถาปนาเป็นคณะที่ 7 ของจุฬาฯ</p><p id="l58">*การแสดงเวลา: 15:00 - 18:00*</p><button><a href="info.html">เพิ่มเติม ></a></button></div></div>',
    ...
    '<div class="info-window" style="height:230px!important"><div class="info-window-header"><img id="checkin" src="icon/5c.png"><h1>เรือนภะรตราชา</h1><h3>RUAN PAROT RACHA (พ.ศ.2456)</h3><div class="facility"></div></div><div class="info-window-pic"><img src="image/parata.png"></div><div class="info-window-content"><img id="show-type" src="icon/Concert.png"><p id="type" style="font-size:8px!important"><แสดงโดย: Pluto boy (วิศวฯ), Begin Again, Mental Breakdance (จิตวิทยาฯ), Thammasorn(ศิษย์เก่าวิศวฯ)></p><p id="content" style="top:35%!important">เรือนที่ใช้เป็นบ้านพักอาจารย์ในสมัยร.6 ภายหลังได้รับการซ่อมแซมจนได้เป็นอาคารอนุรักษ์ดีเด่น และตั้งชื่อเป็นที่ระลึกถึงพระยาภะรตราชา</p><p style="margin-top:75%!important">การแสดงเวลา: 15:00 - 18:00</p><button style="top:95%!important"><a href="info.html">เพิ่มเติม ></a></button></div></div>',
    '<div class="info-window"><div class="info-window-header"><img id="checkin" src="icon/6c.png"><h1>ลานพิพิธศิลป์</h1><h3></h3><div class="facility"></div></div><div class="info-window-pic"><img src="image/run.png"></div><div class="info-window-content"><img id="show-type" src="icon/Concert.png"><img id="show-type2" src="icon/Exhibition.png"><p id="type" style="font-size:8px!important;"><แสดงโดย: Black&Blue (สถาปัตฯ), ECON CU All Gens, Artsband (อักษรฯ)><br><นิทรรศการนวัตกรรมจุฬาฯ></p><p id="content" style="top:35%!important">ลานข้างอาคารพิพิธภัณฑ์จุฬาฯ มีเอกลักษณ์คือ รูปปั้นบูมบาลาก้า</p><p id="l58">*การแสดงเวลา: 15:00 - 18:00*<br></p><button><a href="info.html">เพิ่มเติม ></a></button></div></div>',
    ...
    '<div class="info-window"><div class="info-window-header"><img id="checkin" src="icon/9c.png"><h1>ลานจักรพงษ์</h1><h3>CHAKKRABHONG SQUARE</h3><div class="facility"></div></div><div class="info-window-pic"><img src="image/Chakkapong.png"></div><div class="info-window-content"><img id="show-type" src="icon/Concert.png"><img id="show-type2" src="icon/Exhibition.png"><p id="type" style="font-size:8px"><แสดงโดย: Vivacé (นิติฯ แพทย์ฯ วิศวฯ), BANdSHI (บัญชีฯ), MEAN ><br><นิทรรศการนวัตกรรมจุฬาฯ></p><p id="content" style="top:35%!important">ในปีพ.ศ. 2557 ได้มีเปลี่ยนแปลงบริเวณนี้จากสระว่ายน้ำเป็นสนามหญ้า</p><p id="l57" style="font-size: 8px">*นิทรรศการจัดหน้าตึกมหาวชิรุณหิศ*<br>*การแสดงเวลา: 15.00 - 18.00 น.*</p><button><a href="info.html">เพิ่มเติม ></a></button></div></div>',
    '<div class="info-window"><div class="info-window-header"><img id="checkin" src="icon/white.png"><h1 style="margin-top: 5%!important">PINK MARKET</h1><div class="facility"></div></div><div class="info-window-pic"><img src="image/pinkmarket.jpg" style="border-radius:5px!important;"></div><div class="info-window-content"><img id="show-type" src="icon/Concert.png"><p id="type"><เวทีงานคืนสู่เหย้า></p><p id="content">หลังจากที่เดินชมจุดเช็คอินครบทั้ง 9 จุดแล้ว ขอเชิญทุกท่านมาที่ Pink market ซึ่งอยู่บริเวณลานตรงหน้าพระบรมรูปสองรัชกาล ซึ่งมีดนตรีเวทีใหญ่และร้านค้ามากมาย ลงทะเบียนเข้างานคืนสู่เหย้าได้ตั้งแต่ 17.00 น.</p><button><a href="info.html">เพิ่มเติม ></a></button></div></div>'
  ]
var content_firstaid = [
    'จุดปฐมพยาบาล'
]
var content_parking = [
    '<div><p>อาคารจอดรถ 2: อักษรศาสตร์</p><table><tr><th>ชั่วโมง</th><th>ค่าจอดรถ</th></tr><tr><td>6 ชั่วโมง*</td><td>50.-</td></tr><tr><td>ต่อชั่วโมง</td><td>15.-</td></tr></table><p>*ราคาเมื่อแสดงบัตรเข้างาน</p></div>',
    '<div><p>อาคารจอดรถ 3: รัฐศาสตร์</p><table><tr><th>ชั่วโมง</th><th>ค่าจอดรถ</th></tr><tr><td>6 ชั่วโมง*</td><td>50.-</td></tr><tr><td>ต่อชั่วโมง</td><td>15.-</td></tr></table><p>*ราคาเมื่อแสดงบัตรเข้างาน</p></div>'
]
var content_wc = [
    'สุขาเรือนจุฬานฤมิต',
    'สุขาคณะสถาปัตฯ',
...
var content_other = [
  'จุดถ่ายรูปหน้าศาลาพระเกี้ยว',
  '<div class="info-window" style="height: 80px;"><p>Blue market (บลูมาร์เก็ต) ร้านขายอาหารและเครื่องดื่มจุดลานจักรพงษ์</p><div class="info-window-content" style="height:fit-content"><button style="top: -10px; left: 45px; width:100px;"><a href="info.html" style="font-size: 14px">รายชื่อร้านค้า ></a></button></div></div>',
  '<div class="info-window" style="height: 80px;"><p>ร้านขายอาหารและเครื่องดื่มจุดเรือนภะรตราชา</p><div class="info-window-content" style="height:fit-content"><button style="top: -10px; left: 45px; width:100px;"><a href="info.html" style="font-size: 14px">รายชื่อร้านค้า ></a></button></div></div>'
]
///Chula area///
var cu_area = [
